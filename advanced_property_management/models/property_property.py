...
class Property(models.Model):
    ...
    code = fields.Char(
      ...
      # Trigger the method whenever the ID changes
    # def _compute_apartments(self):
    #     for property_record in self:
    #         # Search for apartments related to the property
    #         apartments = self.env['property.apartment'].search([('property_id', '=', property_record.id)])
    #         # Set the computed Many2many field with the found apartments
    #         property_record.apartment_ids = [(6, 0, apartments.ids)]
